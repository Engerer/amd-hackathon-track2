...
class Settings:
    ...
    caption_candidates: int = 2
    rerank_max_tokens: int = 260
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        caption_candidates=max(1, int(os.getenv("FIREWORKS_CAPTION_CANDIDATES", "2"))),
        rerank_max_tokens=int(os.getenv("FIREWORKS_RERANK_MAX_TOKENS", "260")),
